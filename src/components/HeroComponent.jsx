      ...
      <div className="flex min-h-107.5 flex-col justify-between gap-10 px-12 py-12 lg:flex-row lg:items-center">
        ...
        <div className="max-w-2xl">
          ...
          <h1 className="text-2xl font-bold leading-none text-white lg:text-5xl">
            Welcome back,
            <br />
            <span className="text-[#C8FF00] font-[clash]">
        ...
        <div className="flex flex-row gap-5 lg:flex-col">
          <div
            className="flex h-40 w-44 flex-col items-center justify-center
              ...
              bg-lime-400/10"
          >
            <h2 className="text-5xl font-bold text-[#C8FF00] font-[clash]">
              20+
            </h2>

            <p className="mt-2 text-center text-zinc-400">Products Available</p>
          </div>
