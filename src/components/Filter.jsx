...
const Filter = () => {
  ...
  return (
    <div className="mb-5 rounded-2xl border border-zinc-600 p-4 bg-[#0d0d0d]">
      <div className="flex flex-col gap-4">
        <div className="flex items-center gap-4">
          {/* Search input */}
          <div className="flex items-center gap-3 flex-1 rounded-full bg-[#111111] px-4 py-3">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none rounded-full bg-[#111111] border border-zinc-700 px-4 py-2 pr-10 text-zinc-200"
            >
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none rounded-full bg-[#111111] border border-lime-400/40 px-4 py-2 pr-10 text-zinc-200"
            >
          ...
          {tags.length > 0 && (
            <button
              onClick={clearAll}
              className="rounded-full border border-red-600 px-4 py-2 text-red-400"
            >
              Clear
            </button>
          )}
